...
- **Hunt catalog expansion:** +16 original Aetherion animals (now 46: 19 common / 12 uncommon / 8 rare / 4 epic / 3 mythic) and +12 weapons (now 42; strike/cleave/mend mix). Existing catalog entries kept. Hunt economy, cooldowns, and rarity weights unchanged. Casino, voice, and music untouched.
